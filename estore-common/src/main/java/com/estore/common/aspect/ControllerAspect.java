package com.estore.common.aspect;

import com.alibaba.fastjson.JSON;
import com.estore.common.exception.BaseException;
import com.estore.common.model.Result;
import com.estore.common.model.StatusCode;
...
public class ControllerAspect {
     ...
     * 定义切点Pointcut
     */
    @Pointcut("execution(* com.estore.*.controller.*.*(..))")
